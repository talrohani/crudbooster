...
<head>
    ...
    <link rel="stylesheet" href="{{asset("vendor/crudbooster/assets/css/bootstrap.min.css")}}"
          integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">

    <!-- Optional theme -->
    <link rel="stylesheet" href="{{asset("vendor/crudbooster/assets/css/bootstrap-theme.min.css")}}"
          integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">

    <!-- Latest compiled and minified JavaScript -->
    <script src="{{asset("vendor/crudbooster/assets/js/bootstrap.min.js")}}"
            integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
    <script src="{{asset("vendor/crudbooster/assets/js/jquery.min.js")}}"></script>
</head>
<body>
<div class="container">
